...
class AlphaVantageClient:
    ...
    def get_data(self, endpoint_name: str, params: Dict, force_refresh: bool = False) -> pd.DataFrame:
        """
    ...
    def download_all_data(self, endpoints: Dict, stock_symbols: Optional[List[str]] = None, 
        ...
        for name, params in macro_endpoints.items():
            ...
            self.get_data(name, params, force_refresh=force_refresh)
        ...
        for symbol in stock_symbols:
            for name, params in symbol_endpoints.items():
                ...
                self.get_data(name, param_copy, force_refresh=force_refresh)
